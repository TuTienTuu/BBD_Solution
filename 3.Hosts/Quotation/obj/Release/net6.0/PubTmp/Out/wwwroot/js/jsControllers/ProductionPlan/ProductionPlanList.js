...
function deletePlan(id) {
    ...
    if (confirm("Bạn có chắc chắn muốn xóa?") == true) {
        var url = "/ProductionPlan/Delete/" + id;
...
function show(id) {
    ...
    $.ajax({
        ...
        success: function (mess) {
            ...
            $('#totalQuantity').val(mess.totalQuantity);
            $('#unit').val(mess.unit);
...
$('#btnSave').click(function () {
    ...
    if ($('#numberOfStage').val() == 1 && $('#machine_1').val() == "") {
        alert("Vui lòng nhập máy sản xuất");
        return;
    }
    else if ($('#numberOfStage').val() == 2 && ($('#machine_1').val() == "" || $('#machine_2').val() == "")) {
        alert("Vui lòng nhập máy sản xuất");
        return;
    }
    else if ($('#numberOfStage').val() == 3 && ($('#machine_1').val() == "" || $('#machine_2').val() == "" || $('#machine_3').val() == "")) {
        alert("Vui lòng nhập máy sản xuất");
        return;
    }
    else if ($('#numberOfStage').val() == 4 && ($('#machine_1').val() == "" || $('#machine_2').val() == "" || $('#machine_3').val() == "" || $('#machine_4').val() == "")) {
        alert("Vui lòng nhập máy sản xuất");
        return;
    }
    else if ($('#numberOfStage').val() == 5 && ($('#machine_1').val() == "" || $('#machine_2').val() == "" || $('#machine_3').val() == "" || $('#machine_4').val() == "" || $('#machine_5').val() == "")) {
        alert("Vui lòng nhập máy sản xuất");
        return;
    }
